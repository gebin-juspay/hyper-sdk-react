...
To edit the Objective-C or Swift files, open `example/ios/HyperSdkReactExample.xcworkspace` in XCode and find the source files at `Pods > Development Pods > global-juspay-payments-sdk-react`.

To edit the Java or Kotlin files, open `example/android` in Android studio and find the source files at `global-juspay-payments-sdk-react` under `Android`.
