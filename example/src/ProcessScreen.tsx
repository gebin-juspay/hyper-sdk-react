...
import GlobalJuspayPaymentsSdkReact, { HyperFragmentView } from 'global-juspay-payments-sdk-react';
...
class ProcessScreen extends React.Component {
  ...
  componentDidMount() {
    ...
    this.eventListener = eventEmitter.addListener(
      GlobalJuspayPaymentsSdkReact.GlobalJuspayPaymentsEvent,
      (resp) => {
      ...
      <View style={styles.containerNew}>
        ...
        <CustomButton2
          ...
          onPress={() => {
            ...
            GlobalJuspayPaymentsSdkReact.process(JSON.stringify(payload));
          }}
        />
      </View>
    );
              ...
              <View>
                ...
                <CustomButton
                  ...
                  onPress={() => {
                    ...
                    GlobalJuspayPaymentsSdkReact.processWithActivity(JSON.stringify(payload));
                  }}
                /> */}
          ...
          {/* <View style={styles.containerSon2}>
            <CustomButton3
              ...
              onPress={() => {
                ...
                GlobalJuspayPaymentsSdkReact.process(JSON.stringify(data));
              }}
            />
          </View> */}
        </View>
