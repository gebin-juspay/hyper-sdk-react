...
import LatamJuspayPaymentsSdkReact, { HyperFragmentView } from 'latam-juspay-payments-sdk-react';
...
class ProcessScreen extends React.Component {
  ...
  componentDidMount() {
    ...
    this.eventListener = eventEmitter.addListener(
      LatamJuspayPaymentsSdkReact.LatamJuspayPaymentsEvent,
      (resp) => {
      ...
      <View style={styles.containerNew}>
        ...
        <CustomButton2
          ...
          onPress={() => {
            ...
            LatamJuspayPaymentsSdkReact.process(JSON.stringify(payload));
          }}
        />
      </View>
    );
              ...
              <View>
                ...
                <CustomButton
                  ...
                  onPress={() => {
                    ...
                    LatamJuspayPaymentsSdkReact.processWithActivity(JSON.stringify(payload));
                  }}
                /> */}
          ...
          {/* <View style={styles.containerSon2}>
            <CustomButton3
              ...
              onPress={() => {
                ...
                LatamJuspayPaymentsSdkReact.process(JSON.stringify(data));
              }}
            />
          </View> */}
        </View>
